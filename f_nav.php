...
<body class="bg-gray-100" x-data="{ open: false }">
  ...
  <nav class="bg-black/90 text-white flex justify-between items-center p-2 pb-8 relative">
    ...
    <ul class="hidden md:flex items-center gap-6 text-lg mr-5">
      <li><a href="furniture.php" class="hover:text-blue-400">Home</a></li>
      <li><a href="f_about.php" class="hover:text-blue-400">About</a></li>
      <li><a href="f_product.php" class="hover:text-blue-400">Products</a></li>
      <li><a href="#" class="hover:text-blue-400">Cart</a></li>
      <li><a href="f_contact.php" class="hover:text-blue-400">Contact</a></li>
      <li><a href="../login/f_login_signup.php" class="hover:text-blue-400">➔ / 👤</a></li>
    </ul>
    ...
    <?php if (isset($_SESSION['user_name'])): ?>
      <div class="fixed top-16 right-2 sm:fixed sm:top-24 sm:right-4 sm:-translate-y-1/2 sm:transform flex items-center space-x-2 sm:space-x-3 bg-white/10 px-2 py-1.5 rounded-full shadow-lg backdrop-blur-sm border border-white/20 z-50">
        ...
        <a href="f_logout.php" class="text-xs sm:text-sm bg-red-600 hover:bg-red-700 text-white px-2 sm:px-3 py-0.5 rounded-full transition duration-200 shadow-md">
          Logout
        </a>
      </div>
    <?php endif; ?><?php
...
<?php endif; ?>
  ...
  <div class="fixed top-0 right-0 w-64 max-w-full h-full bg-black text-white transform transition-transform duration-300 ease-in-out z-40"
    ...
    <div class="p-6 flex flex-col gap-5 text-base sm:text-lg">
      ...
      <!-- Sidebar Links -->
      <a href="furniture.php" @click="open = false" class="hover:text-blue-400">Home</a>
      <a href="f_about.php" @click="open = false" class="hover:text-blue-400">About</a>
      <a href="f_product.php" @click="open = false" class="hover:text-blue-400">Products</a>
      <a href="#" @click="open = false" class="hover:text-blue-400">Cart</a>
      <a href="f_contact.php" @click="open = false" class="hover:text-blue-400">Contact</a>
      <a href="../login/f_login_signup.php" @click="open = false" class="hover:text-blue-400">➔ / 👤</a>
    </div>
  </div>
