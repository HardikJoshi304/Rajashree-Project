...
$brandsQuery = $conn->query("SELECT DISTINCT brand FROM e_product WHERE category_id = $category_id ORDER BY brand");
$sizesQuery = $conn->query("SELECT DISTINCT screen_size FROM e_product WHERE category_id = $category_id ORDER BY screen_size");
?>
